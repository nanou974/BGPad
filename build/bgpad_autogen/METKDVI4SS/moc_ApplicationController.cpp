...
#include "../../../src/controllers/ApplicationController.h"
...
static constexpr auto qt_meta_stringdata_ZN21ApplicationControllerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21ApplicationControllerE[] = {
...
Q_CONSTINIT const QMetaObject ApplicationController::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21ApplicationControllerE.offsetsAndSizes,
    qt_meta_data_ZN21ApplicationControllerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21ApplicationControllerE_t,
        // property 'model'
...
void ApplicationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< ApplicationModel* >(); break;
        }
    }
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< ApplicationModel**>(_v) = _t->model(); break;
        default: break;
        }
    }
}
...
void *ApplicationController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21ApplicationControllerE.stringdata0))
